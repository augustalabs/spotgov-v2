  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_outside:
          "day-outside text-muted-foreground aria-selected:bg-muted-foreground/20 aria-selected:text-muted-foreground",
        day_disabled: "text-muted-foreground opacity-50",
        day_range_middle:
          "aria-selected:bg-muted-foreground/20 aria-selected:text-accent-foreground",
