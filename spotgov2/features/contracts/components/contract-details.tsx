...
import { Clock, MoveUpRight, RefreshCcw, Scale, Package, FileText, DollarSign } from 'lucide-react';
          ...
          <div>
            ...
            <div className="flex flex-wrap items-center gap-2">
              {linkDr && (
                ...
                >
                  <a href={linkDr} target="_blank" className="flex items-center space-x-1">
              ...
              {linkDelivery && (
                <Button
                  ...
                  className="border-[1.5px] text-xs font-semibold"
                >
                  <a href={linkDelivery} target="_blank" className="flex items-center space-x-1">
                ...
                <AccordionItem key={index} value={lot.lotNumber || ''}>
                  <AccordionTrigger>
                    <div className="flex w-full items-center justify-between gap-4">
                      <div className="flex items-center gap-2">
                        <Package size={16} />
                        <p className="text-[16px]">Lote {lot.lotNumber} | {lot.description?.substring(0, 30) || ''}</p>
                      </div>
                      <p className="text-[16px]">{lot.basePrice}€</p>
                    </div>
                  </AccordionTrigger>
                  <AccordionContent className="text-[#666F8D] space-y-2">
                    <div className="flex items-center">
                      <FileText size={14} />
